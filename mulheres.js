...
conectaBancoDeDados() //aqui estou chamando a função bancoDeDados

const Mulher = require("./mulherModel")

const app = express () //aqui estou iniciando o app
app.use(express.json()) // aqui libero o json para trafego de dados na request
app.use(cors())
...
app.use(router.get("/mulheres", mostraMulheres)) //segunda configuração da porta, configurei ROTA GET /mulheres
